...
{
public:
    arx_arm(ecat::EcatBase ecat_base,int CONTROL_MODE);
    ~arx_arm()=default;
    ...
    void update_real(ecat::EcatBase ecat_base,command cmd);
    ...
    // void test_update(ecat::Ecat_Outputs_Pack *pack);
    void test_update(ecat::EcatBase ecat_base);
