...
void arx_arm::motor_control(ecat::EcatBase ecat_base)
{
    ...
    if(current_normal)
    {
            ...
            CAN_Handlej.Send_moto_Cmd2(ecat_base,8, 0, 0.1, 0, 0,send_cur );  //0.1
            usleep(200); 
    ...
    {               
            ...
            CAN_Handlej.Send_moto_Cmd2(ecat_base,8, 0, 1, 0, 0, 0);usleep(200); 
...
void arx_arm::init_step(ecat::EcatBase ecat_base)
{
   ...
   if(temp_init>2)
   {
            ...
            CAN_Handlej.Send_moto_Cmd1(ecat_base,1, init_kp, init_kd, target_pos[0], 0,  0);  //150  12
